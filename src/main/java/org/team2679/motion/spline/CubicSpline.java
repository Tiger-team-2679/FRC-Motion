...
public class CubicSpline extends Spline {
    ...
    public CubicSpline(Waypoint startPoint, Waypoint endPoint) throws ArithmeticException{
    ...
    @Override
    public double[] get_point_by_length(double length, int number_of_samples) {
        // TODO implement and add samples exception
        return new double[0];
    }
